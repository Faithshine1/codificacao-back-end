...
process.on ('uncautghtExcepetion',(err) => {
    console.error('[ERRO DE PROCESSO - uncautghtException]: ',err.message);
});
...
app.get('/sucesso', (req,res) =>{
    res.json({sucesso: true, message: 'Operação Realizada com Sucesso!'});
});
